...
class OracleUtill {
    ...
    val save_agreepaper_url : String = "https://finepaper.herokuapp.com//SaveAgreePaper/"
    fun save_agreepaper() : OracleInterface {
        return OracleRequest().getStringResponse(save_agreepaper_url)!!.create(OracleInterface::class.java)
    }
