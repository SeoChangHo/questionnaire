...
//            editTextCondition(isChecked, cancer_3_6_1_editText)
        ...
        cancer_3_7_3.setOnCheckedChangeListener {

            buttonView, isChecked ->

            checkCondition(isChecked, cancer_3_7_wrapper)

            checkCondition(isChecked, cancer_3_7_1_editText)

            editTextCondition(isChecked, cancer_3_7_1_editText)
        ...
        cancer_9_1.setOnCheckedChangeListener {
        ...
        cancer_10_3.setOnCheckedChangeListener {

            buttonView, isChecked ->

            checkCondition(isChecked, cancer_10_detail)
        ...
        if (!AdditionalArr.Gender.isFemale) {
            ...
            cancer_15_radio.visibility = View.GONE
            ...
            cancer_15_radio.visibility = View.VISIBLE
    ...
    fun whenTempSave() {
        ...
        when {
            ...
            cancer_3_6_3.isChecked -> {
                ...
                when {
                    cancer_3_7_1_editText.text.toString() != "" -> ck3_7_kita = cancer_3_7_1_editText.text.toString()
                }
        ...
        when {
            AdditionalArr.Gender.isFemale -> {
                when {
                    ...
                    cancer_9_2.isChecked -> ck8_1 = "2"
                    else -> ""
                }

                when {
                    cancer_10_1.isChecked -> ck9_1 = "1"
                    cancer_10_2.isChecked -> ck9_1 = "2"
                    cancer_10_3.isChecked -> {
                        ck9_1 = "3"
                        ck9_2 = when {
                ...
                ck10 = when {
                    ...
                    cancer_11_4.isChecked -> "4"
                    cancer_11_5.isChecked -> "5"
                    else -> ""
                }
                ...
                ck14 = when {
                    cancer_15_1.isChecked -> "1"
                    cancer_15_2.isChecked -> "2"
                    cancer_15_3.isChecked -> "3"
                    cancer_15_4.isChecked -> "4"
                    else -> ""
                }
            }
        }
        ...
        SavePaper.Total.temp_Cancer = Paper_CANCER(
                ...
                ck3_6, ck3_6_1, ck3_6_2, ck3_6_3, ck3_6_4, ck3_6_5, ck3_7_kita,
    ...
    fun check(): Boolean {
        ...
        if (cancer_3_6_1.isChecked) {
            ...
            if (cancer_3_7_1_editText.text.toString() != "") {
                ck3_6_kita = cancer_3_7_1_editText.text.toString()
            }
        ...
        if (AdditionalArr.Gender.isFemale) {
            ...
            if (cancer_11_1.isChecked) {
                ...
                ck10 = "3"
            } else if (cancer_11_4.isChecked) {
                ck10 = "4"
            } else if (cancer_11_5.isChecked) {
                ck10 = "5"
            } else {
            ...
            if (cancer_15_1.isChecked) {
                ck14 = "1"
            } else if (cancer_15_2.isChecked) {
                ck14 = "2"
            } else if (cancer_15_3.isChecked) {
                ck14 = "3"
            } else if (cancer_15_4.isChecked) {
                ck14 = "4"
            } else {
    ...
    fun whenTempLoad(paper: Paper_CANCER) {
        ...
        if (paper.ck3_6 == "1") {
            ...
            if (paper.ck3_6_kita != "") {
                cancer_3_7_1_editText.setText(paper.ck3_6_kita)
            }
        ...
        } else if (paper.ck11 == "4") {
            cancer_11_4.isChecked = true
        } else if (paper.ck11 == "5") {
            cancer_11_5.isChecked = true
        }
        ...
        } else if (paper.ck13 == "4") {
            cancer_13_4.isChecked = true
        }
        ...
        if (paper.ck14 == "1") {
            cancer_15_1.isChecked = true
        } else if (paper.ck14 == "2") {
            cancer_15_2.isChecked = true
        } else if (paper.ck14 == "3") {
            cancer_15_3.isChecked = true
        }
    ...
    fun GetPaper(paper: Paper_CANCER) {
        ...
        if (paper.ck9_1 == "1") {
            ...
            if (paper.ck9_2.isNullOrEmpty()) {
                ...
                cancer_editText3.setText(paper.ck9_2)
            }
        } else if (paper.ck9_1 == "2") {
            cancer_9_2.isChecked = true
        }
