...
//                    Signature.setImageBitmap(bmp)
        ...
        if(PaperArray.PaperList.Arr_NUTRITION != null && PaperArray.PaperList.Arr_NUTRITION!!.size != 0){

            whenTempLoad(PaperArray.PaperList.Arr_NUTRITION!![0])

        }else if(PaperArray.PaperList.temp_Arr_NUTRITION != null && PaperArray.PaperList.temp_Arr_NUTRITION!!.size != 0){

            whenTempLoad(PaperArray.PaperList.temp_Arr_NUTRITION!![0])
...
//        }
        ...
        if(PaperArray.PaperList.temp_Arr_NUTRITION!!.size < 1) {
            ...
            PaperArray.PaperList.temp_Arr_NUTRITION!!.add(Paper_NUTRITION(exam_date, (SavePaper.Total.Array[0] as PublicDataInfo).exam_no, name, first_serial_text, last_serial_text, category, sg2_spFood1, sg2_spFood2,
...
//        }
        ...
        if(PaperArray.PaperList.Arr_NUTRITION != null && PaperArray.PaperList.Arr_NUTRITION!!.size >= 1) {
            ...
            PaperArray.PaperList.Arr_NUTRITION!!.add(Paper_NUTRITION(exam_date, (SavePaper.Total.Array[0] as PublicDataInfo).exam_no, name, first_serial_text, last_serial_text, category, sg2_spFood1, sg2_spFood2,
                    sg2_spFood3, sg2_spFood4, sg2_spFood5, sg2_spFood6, sg2_spFood7, sg2_spFood8, sg2_spFood9, sg2_spFood10,
                    sg2_spFood11, sg2_spFoodSum, sg2_spFatHeight, sg2_spFatWeight, sg2_spFatWaistSize, sg2_spFatBmi, sg2_spFat1, sg2_spFat2, sg2_spFat3
            ))
            ...
            while(iter!!.hasNext()){
                var arr = iter.next()
                if((arr as ArrayList<*>)[0] is Paper_NUTRITION){
                    iter.remove()
                    iter.add(PaperArray.PaperList.Arr_NUTRITION!!)
                }
            }
            ...
            PaperArray.PaperList.temp_Arr_NUTRITION = ArrayList()
...
//        bmi.setText(paper.sg2_spBmi)
    ...
    override fun onPause() {
        ...
        if(PaperArray.PaperList.Arr_NUTRITION != null && PaperArray.PaperList.Arr_NUTRITION!!.size != 0){
            ...
            PaperArray.PaperList.temp_Arr_NUTRITION = null
            check2()
