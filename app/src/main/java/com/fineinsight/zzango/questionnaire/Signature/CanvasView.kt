...
class CanvasView(internal var context: Context, attrs : AttributeSet?) : View(context, attrs) {
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        if(MainActivity.userName!!.text.toString() != "" && MainActivity.ValidationBool && MainActivity.canvas_motion != null && MainActivity.isJuminValidated){
            ...
            MainActivity.userLoginButton!!.user_login_button.isEnabled = false
            MainActivity.userLoginButton!!.user_login_button.setBackgroundResource(R.drawable.start_login_back)
        }
