                            ...
                            for(i in 0 until response.body()!!.size){
                                userDetailList.add(
                                        ServerPaper_Cancer(
                                                ...
                                                if(response.body()!![i].ck5_6.isNullOrBlank()) "" else response.body()!![i].ck5_6,
                                                ...
                                                if(response.body()!![i].ck6_6.isNullOrBlank()) "" else response.body()!![i].ck6_6,
                                                ...
                                                if(response.body()!![i].ck7_6.isNullOrBlank()) "" else response.body()!![i].ck7_6,
