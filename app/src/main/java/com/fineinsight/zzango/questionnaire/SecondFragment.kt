...
//            }else{
                ...
                (activity as ExamListActivity).userlogin(activity!!.user_login, activity!!.user_image, activity as Context, "MentalExaminationActivity")
...
//            }else{
                ...
                (activity as ExamListActivity).userlogin(activity!!.user_login, activity!!.user_image, activity as Context, "CognitiveExaminationActivity")
...
//            }else{
                ...
                (activity as ExamListActivity).userlogin(activity!!.user_login, activity!!.user_image, activity as Context, "ElderlyExaminationActivity")
