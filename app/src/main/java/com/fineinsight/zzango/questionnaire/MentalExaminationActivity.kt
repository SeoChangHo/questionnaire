    ...
    fun saveCompleteAlert(){
        ...
        dialog_view.return_alert.setOnClickListener {
            ...
            if(AdditionalArr.Page.isOralChecked){
                ...
                startActivity(Intent(this@MentalExaminationActivity, OralExaminationActivity::class.java).putExtra("from", "common").setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP))
                dialog.dismiss()

            }else if(AdditionalArr.Page.isCancerChecked){

                startActivity(Intent(this@MentalExaminationActivity, CancerExaminationActivity::class.java).putExtra("from", "common").setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP))
                dialog.dismiss()
                ...
                startActivity(Intent(this@MentalExaminationActivity, MainActivity::class.java).putExtra("from", "common").setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP))
