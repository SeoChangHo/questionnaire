...
//로컬 저장 리스트
data class Paper(var isChecked: Boolean, var exam_no: String, var category: String, var signature: ByteArray, var name: String) : Serializable
...
data class Paper_CANCER(
        ...
        var ck2:String,
        var ck2_1:String,
        var c_fam_can1:String,
        var c_fam_can1_rel1:String,
        var c_fam_can2:String,
        var c_fam_can1_rel2:String,
        var c_fam_can3:String,
        var c_fam_can1_rel3:String,
        var c_fam_can4:String,
        var c_fam_can1_rel4:String,
        var c_fam_can5:String,
        var c_fam_can1_rel5:String,
        var c_fam_can6:String,
        var c_fam_can1_rel6:String,
        var ck4_1_1:String,
        var ck4_1_2:String,
        var ck4_2_1:String,
        var ck4_3_1:String,
...
data class Paper_EXERCISE (var exam_date : String,
                     ...
                     var sg2_spSportsSum : String) : Serializable
...
data class Paper_NUTRITION (var exam_date : String,
                     ...
                     var sg2_spFat3 : String) : Serializable